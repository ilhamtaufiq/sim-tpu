...
<div class="row">
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Retribusi Tahunan</h4>
                <div class="row">
                    <div class="col-sm-12">
                        <p class="text-muted">Tahun 2022</p>
                        <h3>Rp{{number_format($tahun,2,',','.')}}</h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Makam</p>
                                <h4 class="mb-0">{{$jumlah_registrasi}}</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Retribusi</p>
                                <h4 class="mb-0">Rp{{number_format($retribusi,2,',','.')}}</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Herregistrasi</p>
                                <h4 class="mb-0">Rp0</h4>
                            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Status Data Terbaru</h4>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="align-middle">Registrasi ID</th>
                                <th class="align-middle">Nama Ahli Waris</th>
                                <th class="align-middle">Tahun Registrasi</th>
                                <th class="align-middle">Herregistrasi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="javascript: void(0);" class="text-body fw-bold">{{$item->id_registrasi}}</a> </td>
                                <td>{{$item->nama_ahliwaris}}</td>
                                <td>
                                    {{ date('Y', strtotime($item->created_at))}}
                                </td>
                                <td>
                                    {{$tahun = \Carbon\Carbon::parse($item->tanggal_meninggal)->addYear(2)->format('Y') }}
                                </td>
                                <td>
                                    <span class="badge badge-pill badge-soft-success font-size-11">Lunas</span>
                                </td>
                                <td>
                                    <i class="fab fa-cc-mastercard me-1"></i> Tunai
                                </td>
                                <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-2">ID Registrasi <span class="text-primary">#SK2540</span></p>
