            ...
            <div class="card">
                ...
                <form action="javascript:void(0)" id="skrdform" name="skrdform" method="POST">
                    <div class="invoice-title">
                        <h4 class="float-end font-size-16">Kode Registrasi #{{ $data->id_registrasi }}</h4>
                        <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <address>
                                ...
                                {{ $data->nama_ahliwaris }}<br>
                                {{ $data->alamat_ahliwaris }}<br>
                            </address>
                        </div>
                        <div class="col-sm-6 text-sm-end">
                            <address class="mt-2 mt-sm-0">
                                <strong>Data Makam:</strong><br>
                                {{ $data->nama_meninggal }}<br>
                                {{ $data->nama_tpu }}<br>
                                {{ $data->blok_tpu }}<br>
                        ...
                        <table class="table table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Retribusi</td>
                                    <td class="text-end">{{ $data->retribusi }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Ambulans</td>
                                    <td class="text-end">{{ $data->ambulance }}</td>
                                </tr>
                                <tr>
                                    <td>Total</td>
                                    <td></td>
                                    <td></td>
                                    <td class="text-end">{{$data->retribusi+$data->ambulance}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
