        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('/assets/images/pemda.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/assets/images/pemda.png') }}" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('/assets/images/pemda.png') }}" alt="" height="19">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/pemda.png') }}"
                    alt="Header Avatar">
