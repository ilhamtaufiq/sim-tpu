...
<?php $__env->startSection('css'); ?>
    <!-- ION Slider -->
    <link href="<?php echo e(asset('/assets/libs/ion-rangeslider/ion-rangeslider.min.css')); ?>" rel="stylesheet" type="text/css" />
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('/assets/images/product/img-1.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="<?php echo e(asset('/assets/images/product/img-2.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('/assets/images/product/img-3.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="<?php echo e(asset('/assets/images/product/img-4.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('/assets/images/product/img-5.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Half sleeve T-Shirt</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('/assets/images/product/img-6.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
...
<?php $__env->startSection('script'); ?>
    <!-- Ion Range Slider-->
    <script src="<?php echo e(asset('/assets/libs/ion-rangeslider/ion-rangeslider.min.js')); ?>"></script>

    <!-- init js -->
    <script src="<?php echo e(asset('/assets/js/pages/product-filter-range.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/Admin/resources/views/ecommerce-products.blade.php ENDPATH**/ ?>