                    ...
                    <div class="btn-toolbar">
                        <div class="d-flex flex-wrap gap-2">
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                ...
                                data</button>
                            <a href="<?php echo e(route('export_registrasi')); ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <form action="<?php echo e(route('import_registrasi')); ?>" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="nama_tpu" name="nama_tpu" required>
                                        ...
                                        <?php $__currentLoopData = $tpu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->kode_tpu); ?>"><?php echo e($item->nama_tpu); ?></option>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#id_ahliwaris').select2({
                ...
                ajax: {
                    url: '<?php echo e(route('ahliwaris.search')); ?>',
                    dataType: 'json',
                },
            });
        });
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('registrasi')); ?>",
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        orderable: false
        ...
        function update(id) {
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('registrasi/update')); ?>",
                data: {
                    id: id
                },
                dataType: 'json',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/Admin/resources/views/pages/registrasi/index.blade.php ENDPATH**/ ?>