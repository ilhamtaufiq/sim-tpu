            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    <?php switch(Session::get('lang')):
                        case ('ru'): ?>
                            <img src="<?php echo e(asset('/assets/images/flags/russia.jpg')); ?>" alt="Header Language" height="16"> <span class="align-middle">Russian</span>
                        <?php break; ?>
                        <?php case ('it'): ?>
                            <img src="<?php echo e(asset('/assets/images/flags/italy.jpg')); ?>" alt="Header Language" height="16"> <span class="align-middle">Italian</span>
                        <?php break; ?>
                        <?php case ('de'): ?>
                            <img src="<?php echo e(asset('/assets/images/flags/germany.jpg')); ?>" alt="Header Language" height="16"> <span class="align-middle">German</span>
                        <?php break; ?>
                        <?php case ('es'): ?>
                            <img src="<?php echo e(asset('/assets/images/flags/spain.jpg')); ?>" alt="Header Language" height="16"> <span class="align-middle">Spanish</span>
                        <?php break; ?>
                        <?php default: ?>
                            <img src="<?php echo e(asset('/assets/images/flags/us.jpg')); ?>" alt="Header Language" height="16"> <span class="align-middle">English</span>
                    <?php endswitch; ?>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language" data-lang="eng">
                        <img src="<?php echo e(asset ('/assets/images/flags/us.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="<?php echo e(url('index/es')); ?>" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="<?php echo e(asset ('/assets/images/flags/spain.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>
    
                    <!-- item-->
                    <a href="<?php echo e(url('index/de')); ?>" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="<?php echo e(asset ('/assets/images/flags/germany.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>
    
                    <!-- item-->
                    <a href="<?php echo e(url('index/it')); ?>" class="dropdown-item notify-item language" data-lang="it">
                        <img src="<?php echo e(asset ('/assets/images/flags/italy.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>
    
                    <!-- item-->
                    <a href="<?php echo e(url('index/ru')); ?>" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="<?php echo e(asset ('/assets/images/flags/russia.jpg')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                    </a>
                </div>
            </div>
...
</div><!-- /.modal --><?php /**PATH /Users/ilhamtaufiq/www/Admin/resources/views/layouts/horizontal.blade.php ENDPATH**/ ?>