...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('/assets/js/pages/nik-parse.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('ahliwaris')); ?>",
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        orderable: false
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/Admin/resources/views/pages/ahliwaris/index.blade.php ENDPATH**/ ?>